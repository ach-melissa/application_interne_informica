...
import {
  LayoutDashboard, CreditCard, Wallet,
...
const SidebarComptable = ({ collapsed, setCollapsed }) => {
  ...
  const initials = [user?.prenom?.[0], user?.nom?.[0]].filter(Boolean).join('').toUpperCase() || 'C';
          ...
          >
            ...
            {!collapsed && (
              <div className="text-left">
                ...
                <p className="text-gray-400 text-xs mt-0.5">Comptable</p>
              </div>
            )}
          </button>
