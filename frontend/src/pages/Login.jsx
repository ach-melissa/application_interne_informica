      ...
      <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
        <div className="relative">
          ...
          <input
            ...
            required
            className="w-full border border-gray-200 bg-white shadow-sm rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-950 transition"
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="••••••••"
            required
            className="w-full border border-gray-200 bg-white shadow-sm rounded-xl pl-10 pr-11 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-950 transition"
          />
