...
const salairesMensuelsRoutes = require('./routes/salairesMensuelsRoutes');
const salairesProfesseursRoutes = require('./routes/salairesProfesseursRoutes');
...
app.use('/api/salaires-professeurs', require('./routes/salairesProfesseursMeRoutes'));
