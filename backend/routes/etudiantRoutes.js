...
const { upload, getEtudiants, updateInscription, createEtudiant, updateEtudiant, deleteEtudiant, getGroupsByFormation, assignGroup, archiveInscription, restoreInscription } = require('../controllers/etudiantController');
